...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans selection:bg-emerald-100 selection:text-emerald-900">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              ...
              <Link 
                to="/how-it-works"
                className="w-full sm:w-auto px-8 py-4 bg-white border border-slate-200 text-slate-700 rounded-2xl font-bold text-lg hover:bg-slate-50 transition-all text-center flex items-center justify-center"
              >
                How it works
              </Link>
            </div>
      ...
      <div 
        ref={formRef}
        className={`transition-all duration-1000 ease-in-out ${showForm ? "opacity-100 translate-y-0" : "hidden opacity-0 translate-y-20 pointer-events-none"}`}
      >
      ...
      {/* --- FOOTER --- */}
      <footer className="bg-slate-50 border-t border-slate-200 py-16 mt-12">
