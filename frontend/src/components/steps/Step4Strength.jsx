...
export default function Step4Strength() {
  ...
  const inputStyle = "w-full pl-8 pr-4 py-3 rounded-xl border border-slate-200 bg-slate-50/50 text-slate-900 focus:bg-white focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition-all duration-300 placeholder-slate-400 hover:border-slate-300 hover:bg-slate-50";
